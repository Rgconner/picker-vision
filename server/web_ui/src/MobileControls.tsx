...
export function MobileControls({
  ...
  return (
    <>
      ...
      {lastScanValue && (
        <div className="mx-3 mb-2 px-3 py-2 rounded-lg bg-[#1a1d27] border border-[#2d3142] flex items-center gap-2">
          <span className="text-[#a78bfa] text-xs font-mono">Last scan:</span>
          <span className="text-[#e2e8f0] text-sm font-mono font-semibold truncate flex-1">
            {lastScanValue}
          </span>
        </div>
      )}
      ...
      <div className="flex gap-2 px-3 pb-3">
        ...
        {scanning ? (
          <button
            ...
            className="flex-1 py-3 rounded-xl bg-[#ef4444] text-white font-bold text-sm active:brightness-90 transition-all"
          >
            ■ Stop Scanning
          </button>
        ) : (
          <button
            ...
            className="flex-1 py-3 rounded-xl bg-[#22c55e] text-black font-bold text-sm active:brightness-90 transition-all"
          >
            ▶ Start Scanning
          </button>
        )}
        ...
        <button
          ...
          className="flex-1 py-3 rounded-xl bg-[#eab308] text-black font-bold text-sm disabled:opacity-40 active:brightness-90 transition-all"
        >
          ✓ Validate
        </button>
      </div>
